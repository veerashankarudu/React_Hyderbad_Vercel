    ...
    <div className="login-root">
      ...
      <div className="login-left">
        ...
        <div className="login-form-section">
          ...
          <div className="login-signup-link" style={{ marginTop: '0.4rem', fontSize: '0.85rem' }}>
            <Link to="/forgot-password" style={{ color: '#6983FF' }}>Forgot your password?</Link>
          </div>
        </div>
      </div>
      ...
      <div className="login-right">
        ...
        <div className="login-right-content">
          <img src="/valkey-logo.svg" alt="Valkey" className="login-valkey-logo" />
          <div className="login-ai-badge-tag">TEAM VALKEY × AI</div>
