...
function CircularTimer({ timeLeft, totalTime }) {
  ...
  const color = critical ? '#ef4444' : warn ? '#f59e0b' : '#BCB5E7';
...
function Confetti() {
  const colors = ['#6983FF', '#10b981', '#f59e0b', '#ef4444', '#8BA0FF', '#06b6d4', '#ec4899'];
...
export default function TakeQuiz() {
  ...
  if (step === 'results' && results) {
    ...
    const grade = pct >= 80
      ...
      : pct >= 60
      ? { label: t('tq.gradeGood'),      color: '#6983FF', ring: '#BCB5E7', bg: 'linear-gradient(135deg,#eef2ff,#e0e7ff)' }
      : pct >= 40
            ...
            <div className="tq-score-hero" style={{ background: grade.bg }}>
              ...
              <div className="tq-score-meta">
                ...
                <div className="tq-score-pills">
                  ...
                  <div className="tq-score-pill">
                    <span className="tq-pill-val" style={{ color: '#6983FF' }}>{results.total}</span>
